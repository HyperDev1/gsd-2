...
- 🔄 M001: Verification Enforcement — S01 complete (gate fires, commands discovered, 28 tests). S02 complete (evidence JSON + markdown table, validator enforcement, 15 tests). S03–S05 remaining.
